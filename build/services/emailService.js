      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '"Hỏi Dân IT 👻" <haryphamdev@gmail.com>',
            // sender address
...
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
    result = "\n        <h3>Xin ch\xE0o ".concat(dataSend.patientName, "!</h3>\n        <p>B\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh online tr\xEAn H\u1ECFi D\xE2n IT channel th\xE0nh c\xF4ng.</p>\n        <p>Th\xF4ng tin \u0111\u01A1n thu\u1ED1c/h\xF3a \u0111\u01A1n \u0111\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m.</p>\n       \n        <div> Xin ch\xE2n th\xE0nh c\u1EA3m \u01A1n!</div>\n        ");
  }
  if (dataSend.language === 'en') {
    result = "\n        <h3>Dear ".concat(dataSend.patientName, "!</h3>\n        <p>You received this email because you booked an online medical appointment on the Ask Dan IT channel.</p>\n        <p>bla bla</p>\n        <div> Sincerely thank!</div>\n        ");
  }
